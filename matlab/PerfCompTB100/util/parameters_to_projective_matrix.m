...
if strcmpi(transformType,'TRANSLATION'),
    T(1,3) = xi(1);
    T(2,3) = xi(2);
elseif strcmpi(transformType,'EUCLIDEAN'),
    R = [ cos(xi(1)), -sin(xi(1)); ...
        sin(xi(1)), cos(xi(1)) ];
    T(1:2,1:2) = R;
    T(1,3) = xi(2);
    T(2,3) = xi(3);
elseif strcmpi(transformType,'SIMILARITY'),
    R = [ cos(xi(2)), -sin(xi(2)); ...
        sin(xi(2)), cos(xi(2)) ];
    T(1:2,1:2) = xi(1)*R;
    T(1,3) = xi(3);
    T(2,3) = xi(4);
elseif strcmpi(transformType,'AFFINE'),
    T(1:2,:) = [ xi(1:3)'; xi(4:6)' ];
elseif strcmpi(transformType,'HOMOGRAPHY'),
