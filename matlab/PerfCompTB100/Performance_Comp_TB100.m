...
% resultRootDir: directory where all plots will be stored
% visAOGTrackers: whether to show plots of AOGTracker
% visOtherTrackers: whether to show plots of other trackers
...
nameAOGTrackers = cell(1, length(tmp)-2);
for i = 3 : length(tmp)
